...
String Sheets_GAS_ID = "AKfycbyuUusbYznM0NL3BRLMe89h4FaCGw2sMoQ5PWYDZBSlXWa36jq-DUzF3ulO5jCZx9Y67g";                                         /*This is the Sheets GAS ID, you need to look for your sheets id*/
...
void setup() 
{
  ...
  WIFI_Connect("DJ","787990083333");                                                     /*Provide you Wi-Fi SSID and password to connect to Wi-Fi*/
