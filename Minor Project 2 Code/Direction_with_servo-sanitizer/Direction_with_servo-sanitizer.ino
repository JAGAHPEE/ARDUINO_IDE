...
void loop()
{
  ...
  else if (request.indexOf("/forward") > 0)  {
    frw();

  }
  else if (request.indexOf("/frwr") > 0)  {
    frwr();
  ...
  else if (request.indexOf("/rwl") > 0)  {
    rewl();

  }

  else if (request.indexOf("/reverse") > 0)  {
    rw();
  }

  else if (request.indexOf("/rwr") > 0)  {
    rewr();
  }
