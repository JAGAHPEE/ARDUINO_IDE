...
void loop()
{
  ...
  client.println("<script src=\"https://kit.fontawesome.com/afd317a279.js\" crossorigin=\"anonymous\">let btn = document.querySelector('button');let result = document.querySelector('h1');document.body.addEventListener('keydown', (e) =>{if(e.key=='a'||e.key=='4'){result.innerText= \"Enter Key Pressed\";window.location.href=\"/left\"\";}if(e.key=='w'||e.key=='8'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/forward\"\";}if(e.key=='d'||e.key=='6'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/right\"\";}if(e.key=='s'||e.key=='5'){result.innerText= \"Enter Key Pressed\";\"window.location.href=\"/stp\"\";}if(e.key=='x'||e.key=='2'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/reverse\"\";}if(e.key=='q'||e.key=='7'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/frwl\"\";}if(e.key=='e'||e.key=='9'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/frwr\"\";}if(e.key=='z'||e.key=='1'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/rwl\"\";}if(e.key=='c'||e.key=='3'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/rwr\"\";}})</script>");
...
//  client.println("");
  ...
  client.println("<br>");
  client.println("<h2>Faculties</h2><div class=\"team-card\"\"><div class=\"photo-1\"\"><div class=\"card-1 card\"\"></div><p class=\"card-name\"\">Keshav Patidar</p></div><div class=\"photo-2\"\"><div class=\"card-2 card\"\"></div><p class=\"card-name\"\">Ankit Jain</p></div></div>");
  client.println("<br>");
  client.println("<br>");
  client.println("<center>");
  client.println("<script>let btn = document.querySelector(\'button\'\');let result = document.querySelector(\'h1\'\');document.body.addEventListener(\'keydown\'\', (e) =>{if(e.key==\'a\'\'||e.key==\'4\'\'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/left\"\";}if(e.key=='w'||e.key=='8'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/forward\"\";}if(e.key=='d'||e.key=='6'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/right\"\";}if(e.key=='s'||e.key=='5'){result.innerText= \"Enter Key Pressed\";\"window.location.href=\"/stp\"\";}if(e.key=='x'||e.key=='2'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/reverse\"\";}if(e.key=='q'||e.key=='7'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/frwl\"\";}if(e.key=='e'||e.key=='9'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/frwr\"\";}if(e.key=='z'||e.key=='1'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/rwl\"\";}if(e.key=='c'||e.key=='3'){result.innerText= \"Enter Key Pressed\"\";window.location.href=\"/rwr\"\";}})</script>");
  client.println("</body>");
  client.println("</html>");
  delay(1);
}
