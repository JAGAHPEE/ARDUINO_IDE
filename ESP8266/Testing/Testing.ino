...
void loop()
{
  ...
  client.println("<style>html { font-family: Cairo; display: inline; margin: 0px auto; text-align: center; background-color: ##FAF9F6;}");
//  client.println("button { background-color: #006699; border: none; color: white; padding: 16px 40px;width:200px;");
  client.println("text-decoration: none; font-size: 30px; margin: 2px; cursor: pointer;}");
  client.println("button { background-color: #006699;border: solid black;border-radius: 10px;color: white;padding: 5px;width: 70px;text-decoration: none;font-size: 0.7rem;margin: 2px; cursor: pointer;text-align: center;transition: all 0.5s;}");
  client.println("button:hover {background-color: black;color: white;}");
  client.println(".image{width: auto; height:auto; position: relative;align-items:center;}");
  client.println(".Temperature { background-color: #white; border: solid black 2px; border-radius:  10px; color: black; padding: 16px 40px; width:200px;");
  ...
  client.println(".line{width:100%;height:1px;border:solid 2px black;}");
  ...
  client.println("<br>");
  client.println("<br>");
  client.println("<a href=\"/stop\" width=\"70px\"><button class=\"te\">STOP</button></a>");
  ...
  client.println("<br>");
  client.println("<a href=\"/temperature\"\"><button style=\"background-color: #000000; width: 300px; text-decoration: none; color: #e65715; padding: 5px; border: solid white 5px; border-radius: 0 20px ; font-family: monospace; transition: all 0.5s; font-weight:1000;\"\" class=\"te\">TEMPERATURE</button></a>");
  client.println("<br>");
  client.println("<table class=\"tablea\"><tr><td></td><td><a href=\"/forward\"\"><button>FORWARD</button></a></td><td></td></tr>");
