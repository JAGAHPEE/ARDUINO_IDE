      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            client.println(" <script type = \"text/JavaScript\">function AutoRefresh(t){setTimeout(\"location.reload(true);\",t);}</script>");
            ...
            client.println("<body onload = \"JavaScript:AutoRefresh(6000);\">");
